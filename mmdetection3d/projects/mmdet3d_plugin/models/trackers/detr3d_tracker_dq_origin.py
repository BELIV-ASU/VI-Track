...
class DETR3DTrackerDQ(MVXTwoStageDetector):
    ...
    def sort_and_filter(self, detector, img_metas):
        ...
        # here make the modification img_metas[0]['lidar2ego'][0] -> img_metas[0]['lidar2ego'][0][0]
    ...
    def forward_train(self,
        ...
        """
        img = img[:,:,:6,:,:,:]
        img_metas[0]['lidar2img'][0] = img_metas[0]['lidar2img'][0][:6]
        img_metas[0]['lidar2img'][1] = img_metas[0]['lidar2img'][1][:6]
        img_metas[0]['lidar2img'][2] = img_metas[0]['lidar2img'][2][:6]
        ...
        for batch_idx in range(batch_num):
            ...
            for frame_idx in range(num_frame):
                ...
                img_metas_single[0]['l2g_r_mat'] = img_metas_single[0]['l2g_r_mat'].data[frame_idx][:6]
                img_metas_single[0]['l2g_t'] = img_metas_single[0]['l2g_t'].data[frame_idx][:6]
                if 'uni_rot_aug' in img_metas_single[0]:
                    img_metas_single[0]['uni_rot_aug'] = img_metas_single[0]['uni_rot_aug'][frame_idx]
                
                img_metas_single[0]['pad_shape'] = img_metas_single[0]['pad_shape'][frame_idx][:6]
                img_metas_single[0]['img_shape'] = img_metas_single[0]['img_shape'][frame_idx][:6]
    ...
    def forward_test(self, 
        ...
        for frame_idx in range(num_frame):
            ...
            img_metas_single[0]['l2g_r_mat'] = img_metas_single[0]['l2g_r_mat'].data[frame_idx][:6]
            img_metas_single[0]['l2g_t'] = img_metas_single[0]['l2g_t'].data[frame_idx][:6]
            img_metas_single[0]['lidar2ego'][frame_idx] = img_metas_single[0]['lidar2ego'][frame_idx][:6]
            if 'uni_rot_aug' in img_metas_single[0]:
                img_metas_single[0]['uni_rot_aug'] = img_metas_single[0]['uni_rot_aug'][frame_idx][:6]

            img_metas_single[0]['pad_shape'] = img_metas_single[0]['pad_shape'][frame_idx][:6]
            img_metas_single[0]['img_shape'] = img_metas_single[0]['img_shape'][frame_idx][:6]
            img_metas_single[0]['timestamp'] = img_metas_single[0]['timestamp'][frame_idx]
            img_metas_single[0]['lidar2img'] = img_metas_single[0]['lidar2img'][frame_idx][:6]
            img_metas_single[0]['gt_bboxes_3d'] = img_metas_single[0]['gt_bboxes_3d']._data[frame_idx]
            img_metas_single[0]['gt_labels_3d'] = img_metas_single[0]['gt_labels_3d']._data[frame_idx]
            img_metas_single[0]['box_type_3d'] = img_metas_single[0]['box_type_3d'][frame_idx]
            img_metas_single[0]['cam_intrinsic'] = img_metas_single[0]['cam_intrinsic'][frame_idx][:6]
