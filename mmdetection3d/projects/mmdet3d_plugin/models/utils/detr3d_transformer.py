...
class Detr3DTransformer(BaseModule):
    ...
    def init_weights(self):
        ...
        for m in self.modules():
            if isinstance(m, MultiScaleDeformableAttention) or isinstance(m, Detr3DCrossAttenRaw):
                m.init_weight()
...
class Detr3DCrossAttenRaw(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 batch_first=False):
        super(Detr3DCrossAttenRaw, self).__init__(init_cfg)
