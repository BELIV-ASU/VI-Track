...
def _fill_trainval_infos(nusc,
    ...
    for sample in mmcv.track_iter_progress(nusc.sample):
        ...
        if not test:
            ...
            dims = np.array([ [0.6, b.wlh[1], b.wlh[2]] if b.wlh[0] == 0 else b.wlh for b in boxes ]).reshape(-1, 3)
...
if __name__ == '__main__':
    ...
    create_nuscenes_infos('/scratch/jmeng18/V2X-SIM/', track_info)
    # generate .pkl for test set
    create_nuscenes_infos('/scratch/jmeng18/V2X-SIM/', track_info_test, version='v1.0-test')
